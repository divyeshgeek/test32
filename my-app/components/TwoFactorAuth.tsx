...
const TwoFactorAuth: FC<TwoFactorAuthProps> = ({ otpauth_url, base32, user_id, closeModal }) => {
    ...
    const verifyOtp = async (token: string) => {
        try {
            ...
            const {
                data: { user },
            } = await authApi.post<{ otp_verified: string; user: IUser }>("/auth/otp/verify", {
                token,
                user_id,
            });
            ...
            <div className="relative p-4 w-full max-w-xl h-full md:h-auto left-1/2 -translate-x-1/2">
                <div className="relative bg-white rounded-lg shadow">
                    ...
                    <div className="p-6 space-y-4">
                        <h4 className={styles.heading4}>Configuring Google Authenticator or Authy</h4>
                        <div className={styles.orderedList}></div>
                        <div>
                        ...
                        <form onSubmit={handleSubmit(onSubmitHandler)}>
                            ...
                            <div className={styles.buttonGroup}>
                                <button type="button" onClick={closeModal} className={styles.buttonGrey}>
                                    Close
                                </button>
